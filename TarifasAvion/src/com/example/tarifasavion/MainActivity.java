...
public class MainActivity extends Activity {
    ...
    {
        if ( requestCode == CODIGO_RESPUESTA )//Si el c�digo de respuesta es igual al requestCode
            {
            if (resultCode == Activity.RESULT_OK )//Si resultCode es igual a ok
                {
                    ...
                    //Aqui se hara lo que se desee con el valor recuperado
                    txtTarifa.setText(dato);//El valor recogido en dato es un string que ser mostrado en el TextView de la actividad principal
                }
            }
    }
